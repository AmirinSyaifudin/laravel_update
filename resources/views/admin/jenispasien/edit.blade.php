...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-body">
            <form action="{{ route('admin.jenispasien.update', $jenis_pasien->jenis_pasien_id) }}" method="POST" enctype="multipart/form-data">
             @csrf
             @method("PUT")
            ...
            <div class="form-group @error('nama_jenis_pasien') has-error @enderror">
                ...
                value="{{ $jenis_pasien->nama_jenis_pasien ?? old('nama_jenis_pasien') }}">
            ...
            <div class="form-group">
                <input type="hidden" name="jenis_pasien_id" value="{{$jenis_pasien->jenis_pasien_id}}">
